# Generated by Powerlevel10k configuration wizard on 2026-04-15 at 10:36 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    my_vcs                  # git status (custom: white/orange bg, + for staged)
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#E0E0E0'  # white-ish grey background
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#000000'  # black text
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#555555'  # dark grey (readable on light bg)
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#000000'    # black
  ...
  # Custom git segment: white bg when pushed, orange bg when unpushed.
  # Shows branch name, + for staged changes, and ↑N for unpushed commits.
  function prompt_my_vcs() {
    local branch
    branch=$(git rev-parse --abbrev-ref HEAD 2>/dev/null) || return

    local ahead=0 staged=0
    ...
    local bg='#FFFFFF'   # pure white when pushed / no remote
    local text="$branch"

    (( staged > 0 )) && text+=" +"

    if (( ahead > 0 )); then
      bg='#FF8C00'  # orange when there are unpushed commits
      text+=" ↑$ahead"
    fi

    p10k segment -b $bg -f 0 -t " $text "
  }
